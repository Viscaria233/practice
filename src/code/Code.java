...
public abstract class Code {
    ...
    public final void print() {
        System.out.println(getClass().getSimpleName() + "[" + code + "]");
        System.out.println("value code: [" + valueCode().code + "]");
        System.out.println("true code: [" + trueCode().code + "]");
        System.out.println("comp code: [" + compCode().code + "]");
